...
motor LeftFront = motor(PORT14,gearSetting::ratio18_1,false);
motor LeftBack = motor(PORT3,gearSetting::ratio18_1,false);
motor RightFront = motor(PORT9,gearSetting::ratio18_1,false);
motor RightBack = motor(PORT8,gearSetting::ratio18_1,false);

motor indexer = motor(PORT6,gearSetting::ratio18_1,false);
motor intake = motor(PORT15,gearSetting::ratio36_1,false);

motor SecondaryFly = motor(PORT2,gearSetting::ratio6_1,true);
motor PrimaryFly = motor(PORT1,gearSetting::ratio6_1,false);
