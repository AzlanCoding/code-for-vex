...
vex::motor LF = vex::motor(PORT5, gearSetting::ratio18_1, false);
vex::motor LB = vex::motor(PORT6, gearSetting::ratio18_1, false);
vex::motor RF = vex::motor(PORT7, gearSetting::ratio18_1, true);
vex::motor RB = vex::motor(PORT8, gearSetting::ratio18_1, true);
...
vex::motor FlyWheel = vex::motor(PORT11, gearSetting::ratio6_1,false);
