...
void usercontrol(void) {
  ...
  while (1) {
    ...
    else if (H.ButtonL1.pressing()||H.ButtonL2.pressing()){
      H.rumble("-");
    }
    else {
      intake.spin(directionType::fwd, 0, voltageUnits::volt);
    ...
    if (H.ButtonR2.pressing()==1 /*&& cata.isSpinning()==0 */&& limitSwitch.pressing()==0){//Arm down
    ...
    else if ((H.ButtonR1.pressing()==1 ) && limitSwitch.pressing()==1 /*&& cata.isSpinning()==0*/){
      cata.spin(directionType::fwd, 11.5, voltageUnits::volt);
